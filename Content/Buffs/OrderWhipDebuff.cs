...
{
	public class OrderWhipDebuff : ModBuff
	{
	...
	public class OrderWhipAdvancedDebuff : ModBuff
	{
	...
	public class OrderWhipDebuffNPC : GlobalNPC
	{
		public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers) {
			...
			if (npc.HasBuff<OrderWhipDebuff>()) {
			...
			if (npc.HasBuff<OrderWhipAdvancedDebuff>()) {
				...
				npc.RequestBuffRemoval(ModContent.BuffType<OrderWhipAdvancedDebuff>());
			}
		}
	}
}