...
namespace ChaosStone.Content.Items
{
	public class MusicNote : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.value = Item.buyPrice(silver: 999); // The value of the item in copper coins. Item.buyPrice & Item.sellPrice are helper methods that returns costs in copper coins based on platinum/gold/silver/copper arguments provided to it.
		}
