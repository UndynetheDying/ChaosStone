...
namespace ChaosStone.Content.Items.Weapons
{
	...
	public class SpotiHarmonica : ModItem
	{
		public override void SetDefaults() {
			...
			Item.damage = 180; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ModContent.ItemType<MusicNote>(), 35)
