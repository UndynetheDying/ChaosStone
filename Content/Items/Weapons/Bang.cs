...
namespace ChaosStone.Content.Items.Weapons
{
	public class Bang : ModItem
	{
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ItemID.MusketBall, 2000)
				.Register();
		}
