...
namespace ChaosStone.Content.Items.Weapons
{
	...
	public class OrderBombs : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DamageType = DamageClass.Magic; // What type of damage does this item affect?
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.OrderBombsProjectile>();
            Item.mana = 15;
		}
