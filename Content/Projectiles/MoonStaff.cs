...
namespace ChaosStone.Content.Projectiles.Minions
{
	...
	public class MoonMinionBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<MoonMinion>()] > 0) {
	...
	public class MoonStaff : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<MoonMinionBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<MoonMinion>(); // This item creates the minion projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient(ItemID.IronBar, 70)
	...
	public class MoonMinion : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<MoonMinionBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<MoonMinionBuff>())) {
