...
namespace ChaosStone.Content.Projectiles.Minions
{
	...
	public class BeetleStaff : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<BeetleMinionBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<BeetleMinion>(); // This item creates the minion projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient(ItemID.BeetleHusk, 70)
	...
	public class BeetleMinion : ModProjectile
	{
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<BeetleMinionBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<BeetleMinionBuff>())) {
