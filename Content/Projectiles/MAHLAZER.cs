using ChaosStone.Content.Items.Weapons;
...
{
	public class MAHLAZER : ModProjectile
	{
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<MahLazerBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
